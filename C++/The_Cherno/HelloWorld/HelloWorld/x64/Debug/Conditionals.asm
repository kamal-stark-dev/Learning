...
__45D8812C_Conditionals@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_0BB@FHADLPGD@?5is?5equal?5to?55?4?6@	; `string'
PUBLIC	??_C@_0BC@LIKILGGI@ptr?5is?5not?5null?4?6@	; `string'
PUBLIC	??_C@_0O@IIEJPLHC@ptr?5is?5null?4?6@		; `string'
EXTRN	strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0O@IIEJPLHC@ptr?5is?5null?4?6@
CONST	SEGMENT
??_C@_0O@IIEJPLHC@ptr?5is?5null?4?6@ DB 'ptr is null.', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@LIKILGGI@ptr?5is?5not?5null?4?6@
CONST	SEGMENT
??_C@_0BC@LIKILGGI@ptr?5is?5not?5null?4?6@ DB 'ptr is not null.', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@FHADLPGD@?5is?5equal?5to?55?4?6@
CONST	SEGMENT
??_C@_0BB@FHADLPGD@?5is?5equal?5to?55?4?6@ DB ' is equal to 5.', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
ptr$ = 40
main	PROC						; COMDAT
; File C:\Users\91638\Desktop\Learning MF\Learning\C++\The_Cherno\HelloWorld\HelloWorld\Conditionals.cpp
; Line 5
$LN6:
	push	rbp
	push	rdi
	...
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__45D8812C_Conditionals@cpp
	call	__CheckForDebuggerJustMyCode
	npad	1
; Line 9
...
; Line 10
	...
	lea	rdx, OFFSET FLAT:??_C@_0BB@FHADLPGD@?5is?5equal?5to?55?4?6@
	mov	rcx, rax
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	npad	1
$LN2@main:
; Line 12
	mov	QWORD PTR ptr$[rbp], 0
; Line 13
	cmp	QWORD PTR ptr$[rbp], 0
	je	SHORT $LN3@main
; Line 14
	lea	rdx, OFFSET FLAT:??_C@_0BC@LIKILGGI@ptr?5is?5not?5null?4?6@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	npad	1
	jmp	SHORT $LN4@main
$LN3@main:
; Line 16
	lea	rdx, OFFSET FLAT:??_C@_0O@IIEJPLHC@ptr?5is?5null?4?6@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	npad	1
$LN4@main:
