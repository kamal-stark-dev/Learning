...
; File C:\Users\91638\Desktop\Learning MF\Learning\C++\The_Cherno\HelloWorld\HelloWorld\Log.cpp
; Line 5
$LN3:
	mov	QWORD PTR [rsp+8], rcx
	push	rbp
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__822FA675_Log@cpp
	call	__CheckForDebuggerJustMyCode
	npad	1
; Line 6
